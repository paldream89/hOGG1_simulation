...
sim_num = 10000 # must be even number!!!
...
gold = 0.6180339887
# bin_range = (0,sphere_diameter+2*localization_precision)
...
disp_hist = hist(xy_disp_array,bins=bin_number,range=(0,sphere_diameter+2*localization_precision),rwidth=0.8)
...
try: 
    ...
    smooth_x = np.linspace(0,sphere_diameter+2*localization_precision,num=int(100))
